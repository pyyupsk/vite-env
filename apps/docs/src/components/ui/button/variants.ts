  ...
  'inline-flex items-center font-sans cursor-pointer transition-colors duration-fast',
  {
    variants: {
      variant: {
        ...
        secondary: 'bg-surface-raised text-text-body border border-border-default hover:border-border-strong',
        ghost:     'bg-transparent text-text-subtle border border-transparent hover:text-text-body hover:bg-surface-raised',
      },
      size: {

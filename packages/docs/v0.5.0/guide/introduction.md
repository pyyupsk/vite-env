...
Presets provide validated, typed schemas for all platform environment variables. Your definitions always win over preset values. See [Platform Presets](/v0.5.0/guide/platform-presets) for details.

---

Ready to add it to a project? See [Quick Start](/v0.5.0/guide/quick-start).
